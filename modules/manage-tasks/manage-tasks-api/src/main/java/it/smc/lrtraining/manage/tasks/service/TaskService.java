...
@OSGiBeanProperties(property =  {
	"json.web.service.context.name=mt", "json.web.service.context.path=Task"}, service = TaskService.class)
@ProviderType
...
public interface TaskService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TaskServiceUtil} to access the task remote service. Add custom service methods to {@link it.smc.lrtraining.manage.tasks.service.impl.TaskServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
